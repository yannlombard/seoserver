...
<code>
    angular.module('stApp', ['ngRoute']).config(function ($routeProvider, $locationProvider) {<br>
        $locationProvider.html5Mode(true).hashPrefix('!');<br>
        $routeProvider.when('/', {<br>
